...
**[Download SwashMoji for Windows x64](https://github.com/Jovlang/SwashMoji/releases/download/v0.4.0/SwashMoji-portable.zip)** — portable ZIP, no installation required.
...
See the [v0.4.0 release](https://github.com/Jovlang/SwashMoji/releases/tag/v0.4.0) for release notes and the SHA-256 checksum.
